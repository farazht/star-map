...
from utils import np, sf, plt, ps, dt, load, tzwhere, timezone, utc, wgs84, Star, build_stereographic_projection
...
utc_dt = local_timezone.localize(dt, is_dst=None).astimezone(utc)
